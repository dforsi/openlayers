...
OpenLayers.Lang.it = {
    ...
    'minZoomLevelError':
        ...
        "e sarà rimossa dalla versione 3.0. Si prega di utilizzare i " +
    ...
    'googleWarning':
        ...
        "Più precisamente, ciò accade perché la libreria Google Maps " +
    ...
    'getLayerWarning':
        ...
        "Per evitare questo messaggio, seleziona un nuovo BaseLayer " +
        "nel selettore di livelli nell'angolo in alto a destra.<br><br>" +
        "Più precisamente, ciò accade perché la libreria ${layerLib} " +
